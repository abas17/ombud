...
if (isset($_GET['id']) && $_GET['id'] <> '') {
    ...
    if (isset($row['id_reg'])) {
        if (isset($_POST['button_update'])) {
            $updateSql = "UPDATE registrasi_lap_masyarakat SET tgl_agenda = ?, tipe_laporan = ?, cara_penyampaian = ?, no_agenda = ?, no_arsip = ?, substansi = ? WHERE id_reg = ?";
                                            ...
                                            <div class="col s12">
                                                <div class="input-field col s12">
                                                    ...
                                                    <select class="select2 browser-default" name="substansi" id="substansi">
                                                        ...
                                                        <?php
                                                        $selectSql = "SELECT * FROM substansi s left JOIN registrasi_lap_masyarakat r ON r.substansi=s.id_sub";
                                                ...
                                                <div class="input-field col s12">
                                                    <?php
                                                    $selectSql = "SELECT * FROM registrasi_lap_masyarakat";
                                                    $stmt = $db->prepare($selectSql);
                                                    $stmt->execute();
                                                    $row = $stmt->fetch();
                                                    ?>
