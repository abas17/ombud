...
$pleno   = $_GET['pleno'];
if ($_GET['pleno'] == 'any') $sqlPleno = "AND kewenangan_ombudsman=kewenangan_ombudsman";
if ($_GET['pleno'] == 'Kewenangan Ombudsman') $sqlPleno = "AND kewenangan_ombudsman='Kewenangan Ombudsman'";
if ($_GET['pleno'] == 'Ditolak') $sqlPleno = "AND kewenangan_ombudsman='Ditolak'";
