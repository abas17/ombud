...
$status   = $_GET['status'];
if ($_GET['status'] == 'any') $sqlDurasi = "WHERE durasi=durasi";
if ($_GET['status'] == 'Proses') $sqlDurasi = "WHERE durasi='Proses'";
if ($_GET['status'] == 'Berhenti') $sqlDurasi = "WHERE durasi='Berhenti'";
if ($_GET['status'] == 'Selesai') $sqlDurasi = "AND durasi='Selesai'";

$tipelap = $_GET['tipelap'];
if ($_GET['tipelap'] == 'any') {
                ...
                <center>
                    <table id='page-length-option' border='1' style='width:90%;' class='display'>
                        ...
                        <tbody>
                            ...
                            JOIN terlapor t ON p.id_pel=t.id_ter $sqlDurasi $sqlTipeLap $sqlCapeny ORDER BY id_reg desc";
