                                            ...
                                            <div id="laporan" class="col s12">
                                                <form class="row mt-2 mb-2">
                                                    ...
                                                    <div class="col s12">
                                                        ...
                                                        <div class="input-field col s12">
                                                            <input value="" id="cara-penyampaian" name="cara-penyampaian" type="text" class="validate">
                                                            <label for="cara-penyampaian">Cara Penyampaian</label>
                                                        </div>
                                                        <div class="input-field col s12">
                                                            <input value="" id="no-agenda" name="no-agenda" type="text" class="validate">
                                                            <label for="no-agenda">Nomor Agenda</label>
                                                        </div>
                                                        <div class="input-field col s12">
                                                            <input value="" id="no-arsip" name="no-arsip" type="text" class="validate">
                                                            <label for="no-arsip">Nomor Arsip</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col s12">
                                                        <div class="input-field col s12">
                                                            ...
                                                            <select class="select2 browser-default" name="substansi">
                                                                ...
                                                                <option value="substansi_1">Administrasi Kependudukan</option>
                                                                <option value="substansi_">Agraria</option>
                                                                <option value="substansi_3">Air</option>
                                                                <option value="substansi_4">Asuransi</option>
                                                                <option value="substansi_5">Bea dan Cukai</option>
                                                                <option value="substansi_">Energi dan Kelistrikan</option>
                                                                <option value="substansi_">Hak Kekayaan Intelektual</option>
                                                                <option value="substansi_">Hak Sipil dan Politik</option>
                                                                <option value="substansi_">Jaminan Sosial</option>
                                                                <option value="substansi_2">Keagamaan</option>
                                                                <option value="substansi_">Kedaruratan</option>
                                                                <option value="substansi_">Kehutanan</option>
                                                                <option value="substansi_">Keimigrasian</option>
                                                                <option value="substansi_">Kejaksaan</option>
                                                                <option value="substansi_">Kepegawaian</option>
                                                                <option value="substansi_">Kepolisian</option>
                                                                <option value="substansi_">Kesehatan</option>
                                                                <option value="substansi_">Kesejahteraan Sosial</option>
                                                                <option value="substansi_">Ketenagakerjaan</option>
                                                                <option value="substansi_">Koperasi</option>
                                                                <option value="substansi_">Lembaga Pemasyarakatan</option>
                                                                <option value="substansi_">Lingkungan Hidup</option>
                                                                <option value="substansi_">Pajak</option>
                                                                <option value="substansi_">Pedesaan</option>
                                                                <option value="substansi_">Pegadaian</option>
                                                                <option value="substansi_">Penanaman Modal</option>
                                                                <option value="substansi_">Pendidikan</option>
                                                                <option value="substansi_">Pengadaan Barang, Jasa, dan Lelang</option>
                                                                <option value="substansi_">Peradilan</option>
                                                                <option value="substansi_">Perbankan</option>
                                                                <option value="substansi_">Perdagangan, Industri dan Logistik</option>
                                                                <option value="substansi_">Perhubungan dan Infrastruktur</option>
                                                                <option value="substansi_">Perikanan</option>
                                                                <option value="substansi_">Perizinan</option>
                                                                <option value="substansi_">Permukiman dan Perumahan</option>
                                                                <option value="substansi_">Pertahanan</option>
                                                                <option value="substansi_">Pertambangan</option>
                                                                <option value="substansi_">Pertanian dan Pangan</option>
                                                                <option value="substansi_">Telekomunikasi dan Informatika</option>
                                                                <option value="substansi_">Transmigrasi</option>
                                                            </select>
                                                        </div>
                                                        <div class="input-field col s12">
                                                            <div>
                                                                <label for="pokok_permasalahan">Pokok Permasalahan</label>
                                                            </div>
                                                            <select class="select2 browser-default" name="pokok_permasalahan">
